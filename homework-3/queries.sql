...
WHERE customers.city='London' AND ship_via IN (SELECT shipper_id FROM shippers WHERE company_name ='United Package')
...
WHERE discontinued=0 AND units_in_stock<25 AND category_id IN (SELECT category_id FROM categories
